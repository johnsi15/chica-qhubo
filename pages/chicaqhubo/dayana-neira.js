          ...
          <div className={styles.content}>
            ...
            <div className={styles.block_content}>
              <div className={styles.content_image}>
                <Image
                  src='/dayana-neira/principal.png'
                  alt='Dayana Neira'
                  layout='responsive'
                  width={286}
                  height={429}
              ...
              <div className={styles.content_info}>
                <h5>Carmen Dayana Neira Pacheco</h5>
                <p>
                  Edad: 20 años. <br />
                  Medidas: 86-60-90. <br />                  
                  Estudios: Ingeniería biotecnológica. <br />
                  Agencia de modelo: @classfashionmodels <br />
                  Proyectos:  Participar en más reinados y crear su propio negocio. <br />
                  Hobbies: Practicar fútbol y softbol, leer, investigar y la gestión social. <br />
                  Fortaleza: Expresarse bien en público, responsable y pulcra.
                </p>
              </div>
            </div>
