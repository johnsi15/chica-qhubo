          ...
          <div className={styles.content}>
            ...
            <div className={styles.block_content}>
              <div className={styles.content_image}>
                <Image
                  src='/harly-padilla/principal.png'
                  alt='Harly Padilla'
                  layout='responsive'
                  width={286}
                  height={429}
              ...
              <div className={styles.content_info}>
                ...
                <p>
                  Edad: 28 años. <br />
                  Medidas: 90-61-90. <br />                  
                  Estudios: Derecho y modelaje profesional. <br />
                  Agencia de modelo: @classfashionmodels <br />
                  Proyectos: Tener su propia agencia de modelos. <br />
                  Hobbies: Leer y bailar.  <br />
                  Fortaleza: Ser positiva y perseverante.
                </p>
              </div>
            </div>
