          ...
          <div className={styles.content}>
            ...
            <div className={styles.block_content}>
              <div className={styles.content_image}>
                <Image
                  src='/celena-manosalva/foto-3.png'
              ...
              <div className={styles.content_info}>
                <h5>Andrea Celena Manosalva Salazar</h5>
                <p>
                  Edad: 20 años. <br />
                  Medidas: 68-93-81. <br />                  
                  Estudios: Enfermería en el Sena. <br />
                  Agencia de modelo: @classfashionmodels <br />
                  Proyectos: Tener un cargo como jefe de enfermería y seguir en el mundo del modelaje para ayudar a su familia. <br />
                  Hobbies: Bailar. 
                </p>
              </div>
            </div>
            ...
            <Modal onClose={() => setShowModal(false)} show={showModal}>
              ...
              >
                <SplideSlide>
                  <Image
                    src='/celena-manosalva/foto-1.png'
                    alt='Celena Manosalva'
                    layout='responsive'
                    width={492}
                    height={739}
                ...
                <SplideSlide>
                  <Image
                    src='/celena-manosalva/foto-4.png'
                    alt='Celena Manosalva'
                    layout='responsive'
                    width={492}
                    height={739}
                ...
                <SplideSlide>
                  <Image
                    src='/celena-manosalva/foto-5.png'
                    alt='Celena Manosalva'
                    layout='responsive'
                    width={492}
                    height={739}
                ...
                <SplideSlide>
                  <Image
                    src='/celena-manosalva/foto-6.png'
                    alt='Celena Manosalva'
                    layout='responsive'
                    width={492}
                    height={739}
